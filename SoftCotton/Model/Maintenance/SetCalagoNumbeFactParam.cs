...
{
    public class SetCalagoNumbeFactParam
    {
        ...
        public SetCalagoNumbeFactParam()
        {
            opcion = 0;
            codigoInterno = "";
            idCategoria = 0;
            ...
            codMoneda = "";
            descripcionCatalogo = "";
            ventaValorUnitarioSinIgv = 0;
            ventaPrecioUnitarioIgv = 0;
            compraPrecioUnitarioIgv = 0;
            compraValorUnitarioSinIgv = 0;
            destacado = "";
            tipoAfectacionIgv = "";
            codProductoSunat = "";
            stockActualDisponible = 0;
        }
