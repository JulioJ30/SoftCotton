...
{
    public partial class OrdenCompraRpteViewV2 : Form
    {

        OrdenCompraModelV2 modelo;
        OrdenCompraBL _ordenCompraBL;
        int _ordenCompra;

        public OrdenCompraRpteViewV2(int ordenCompra)
        {
            InitializeComponent();


            modelo = new OrdenCompraModelV2();
            _ordenCompraBL = new OrdenCompraBL();
            _ordenCompra = ordenCompra;

        }

        private void OrdenCompraRpteViewV2_Load(object sender, EventArgs e)
        {
        ...
        {
            modelo = _ordenCompraBL.RpteOrdenCompraV2(idEmpresa, idOC);
        ...
        private void CrearReporte(OrdenCompraModelV2 pModelo)
        {
            int contador = 1;
        ...
        private void OrdenCompraRpteViewV2_FormClosed(object sender, FormClosedEventArgs e)
        {
            Cursor = Cursors.Default;
        }
    }
