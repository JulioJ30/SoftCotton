...
{
    public partial class TipoAnuladoOSView : Form
    {
        OrdenServicioBL _ordenServicioBL;
        SetOSTipoAnuladoParam _tipoAnuladoParam;

        public TipoAnuladoOSView()
        {
            InitializeComponent();
            _ordenServicioBL = new OrdenServicioBL();
        }

        private void TipoAnuladoOSView_Load(object sender, EventArgs e)
        {
            Limpiar();
            Listar();
        ...
        private void dgvListado_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dgvListado.Columns[e.ColumnIndex].Name.Equals("cbtnEliminar"))
            {
                if (Convert.ToBoolean(dgvListado.Rows[e.RowIndex].Cells["cbxActivo"].Value))
                {
                    ...
                    {
                        _tipoAnuladoParam = new SetOSTipoAnuladoParam();
        ...
        public void Procesar(SetOSTipoAnuladoParam parametro)
        {
            Response responseGeneral = _ordenServicioBL.SetOSTipoAnulado(parametro);
        ...
        public void Listar()
        {
            List<GetOS6_TipoAnulado> listaCeCos = _ordenServicioBL.Get6_TipoAnulados();
