...
{
    public partial class BuscarUsuarioOSView : Form
    {
        OrdenServicioBL _ordenCompraBL;
        public string idUsuario = "";
        public string colaborador = "";


        public BuscarUsuarioOSView()
        {
            InitializeComponent();
            _ordenCompraBL = new OrdenServicioBL();
        }

        private void BuscarUsuarioOSView_Load(object sender, EventArgs e)
        {
