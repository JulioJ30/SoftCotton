...
{
    public partial class ReporteOSView : Form
    {
        OrdenServicioBL _guiaOC;
        List<GetOS19_Reporte> lista;


        public ReporteOSView()
        {
            InitializeComponent();

            _guiaOC = new OrdenServicioBL();
            lista = new List<GetOS19_Reporte>();
        }

        private void ReportOSView_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in lista)
            {
                ...
                dgvListado.Rows[index].Cells["dgvidOS"].Value = item.idOS;
            ...
            if (dgvListado.Rows.Count > 0)
            {
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    if (!string.IsNullOrEmpty(sfd.FileName))
                    {
                        ...
                        arrayTitulo[1] = new ExcelReportTitulo() { titulo = "OS", backgroundColor = XLColor.LightBlue, foreColor = XLColor.Black };
                        ...
                        arrayTitulo[9] = new ExcelReportTitulo() { titulo = "Estado OS", backgroundColor = XLColor.LightBlue, foreColor = XLColor.Black };
                        arrayTitulo[10] = new ExcelReportTitulo() { titulo = "Usuario Registro OS", backgroundColor = XLColor.LightBlue, foreColor = XLColor.Black };
                        arrayTitulo[11] = new ExcelReportTitulo() { titulo = "Fecha Registro OS", backgroundColor = XLColor.LightBlue, foreColor = XLColor.Black };
                        ...
                        ExcelReport.GetExcelReport<GetOS19_Reporte>(sfd.FileName, arrayTitulo, lista);
