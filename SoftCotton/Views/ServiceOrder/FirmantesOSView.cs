...
{
    public partial class FirmantesOSView : Form
    {
        OrdenServicioBL _ordenServicioBL;
        SetOSFirmantesParam _firmanteParam;
        GetOS15_FirmanteXNivel _firmanteInicial;


        public FirmantesOSView()
        {
            InitializeComponent();

            _ordenServicioBL = new OrdenServicioBL();
            _firmanteParam = new SetOSFirmantesParam();
            _firmanteInicial = new GetOS15_FirmanteXNivel();

        }

        private void FirmantesOSView_Load(object sender, EventArgs e)
        {
            Limpiar();
        ...
        {
            BuscarUsuarioOSView usuarioView = new BuscarUsuarioOSView();
        ...
        {
            List<GetOC13_TiposAprobacion> cbxTipoDocList = _ordenServicioBL.Get13_TiposAprobacion();
        ...
        public void Procesar(SetOSFirmantesParam parametro)
        {
            Response responseGeneral = _ordenServicioBL.SetOSFirmantes(parametro);
        ...
        {
            List<GetOS11_Firmantes> listaFirmantes = _ordenServicioBL.Get11_Firmantes(idEmpresa);
