...
{
    public partial class ObservacionesOCView : Form
    {
        OrdenCompraBL _ordenCompraBL;
        SetOCObservacionParam _observacionParam;


        public ObservacionesOCView()
        {
            InitializeComponent();
        ...
        private void ObservacionesOCView_Load(object sender, EventArgs e)
        {
            Limpiar();
            Listar();
        ...
        private void dgvListado_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dgvListado.Columns[e.ColumnIndex].Name.Equals("cbtnEliminar"))
            {
                if (Convert.ToBoolean(dgvListado.Rows[e.RowIndex].Cells["cbxActivo"].Value))
                {
                    ...
                    {
                        _observacionParam = new SetOCObservacionParam();
        ...
        public void Procesar(SetOCObservacionParam parametro)
        {
            Response responseGeneral = _ordenCompraBL.SetOCObservacion(parametro);
        ...
        public void Listar()
        {
            List<GetOC14_Observaciones> listaObservaciones = _ordenCompraBL.Get14_Observaciones();
